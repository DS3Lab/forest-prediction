...
def get_item(hansen_file):
    ...
    tile_template = 'pl2017_{q}_16_{x}_{y}.png'
    tiles = utils3m.zoom2tiles(z, x, y, 16)
    path_dict = {}
    for tile in tiles:
...
class PlanetSingleDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # z16 tile info
        beg_x, beg_y, num_tiles = utils3m.zoom2zoom(z, x, y 16)
        ...
        img_dict['big_mask'] = upsample_tile(12, 16, mask_arr)
        img_dict['key'] = torch.tensor([x, y])
        return img_dict

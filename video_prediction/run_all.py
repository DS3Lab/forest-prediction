...
cmd_template = 'python scripts/generate.py --input_dir {input_dir} --dataset cropped --dataset_hparams sequence_length=4 --checkpoint {model_dir} --mode test --results_dir {output_dir} --batch_size 1'

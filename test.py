    ...
    with torch.no_grad():
        ...
        # for i, (data, target) in enumerate(tqdm(data_loader)):
            if timelapse == 'quarter':
                ...
                uimg0, uimg1, uimg2 = normalize_inverse(img0, (0.2397, 0.2852, 0.1837), (0.1685, 0.1414, 0.1353)), \
                        normalize_inverse(img1, (0.2397, 0.2852, 0.1837), (0.1685, 0.1414, 0.1353)), \
                        normalize_inverse(img2, (0.2397, 0.2852, 0.1837), (0.1685, 0.1414, 0.1353))
            ...
            if config['data_loader_val']['args']['timelapse'] == 'quarter':
            # save sample images, or do something with output here
                print('Save images shape input', images['img'].shape)
                save_images(3, images, out_dir, i*batch_size)
            else:
                print('Save images shape input', images['img'].shape)
                save_images(3, images, out_dir, i*batch_size)

...
class PlanetCycleDataset(BaseDataset):
    """
    ...
    def __init__(self, opt):
        ...
        self.A_paths = make_dataset(self.input_dir)
        self.B_paths = make_dataset(self.target_dir)
        self.A_size = len(self.A_paths)
        self.B_size = len(self.B_paths)
        self.size = max(self.A_size, self.B_size)
    ...
    def __getitem__(self, index):
        ...
        B_path = self.B_paths[index_B]  # make sure index is within then range

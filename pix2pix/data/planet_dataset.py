...
class PlanetDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.A_paths = sorted(make_dataset(self.dir, 'pl', opt.years, opt.max_dataset_size))   # load images from '/path/to/data/trainA'
        self.B_paths = sorted(make_dataset(self.dir, 'ly', opt.years, opt.max_dataset_size))    # load images from '/path/to/data/trainB'
    ...
    def __getitem__(self, index):
        ...
        B = torch.from_numpy(B_img).float().unsqueeze(0)
